...
public:
    ...
    float calculate_heading(const Matrix3f &dcm_matrix) const {
        return calculate_heading(dcm_matrix, get_first_usable());
    }
    ...
    const Vector3f &get_field(void) const { return get_field(get_first_usable()); }
    ...
    */
    ...
    bool healthy(void) const { return healthy(get_first_usable()); }
    ...
    const Vector3f &get_offsets(void) const { return get_offsets(get_first_usable()); }

    const Vector3f &get_diagonals(uint8_t i) const { return _get_state(Priority(i)).diagonals; }
    const Vector3f &get_diagonals(void) const { return get_diagonals(get_first_usable()); }

    const Vector3f &get_offdiagonals(uint8_t i) const { return _get_state(Priority(i)).offdiagonals; }
    const Vector3f &get_offdiagonals(void) const { return get_offdiagonals(get_first_usable()); }
    ...
    const Vector3f& get_motor_compensation(void) const { return get_motor_compensation(get_first_usable()); }
    ...
    const Vector3f &get_motor_offsets(void) const { return get_motor_offsets(get_first_usable()); }
    ...
    uint32_t last_update_usec(void) const { return last_update_usec(get_first_usable()); }
    uint32_t last_update_usec(uint8_t i) const { return _get_state(Priority(i)).last_update_usec; }

    uint32_t last_update_ms(void) const { return last_update_ms(get_first_usable()); }
    ...
    // get the first compass marked for use
    uint8_t get_first_usable(void) const;
