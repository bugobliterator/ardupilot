...
#ifndef AP_CUSTOMCONTROL_SIMULINK_ENABLED
#if defined(SIMULINK_APP_ENABLED)
#define AP_CUSTOMCONTROL_SIMULINK_ENABLED AP_CUSTOMCONTROL_BACKEND_DEFAULT_ENABLED
#else
#define AP_CUSTOMCONTROL_SIMULINK_ENABLED 0
#endif
#endif
